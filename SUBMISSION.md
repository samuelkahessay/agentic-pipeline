# Wealthsimple AI Builder Submission — [prd-to-prod](https://github.com/samuelkahessay/prd-to-prod)
...
The same logic governs the pipeline itself. [`gh-aw`](https://github.com/github/gh-aw/) (GitHub Agentic Workflows) agents handle decomposition, implementation, review, and repair. GitHub Actions handles routing, merge gates, deploy policy, and authority enforcement. The agents operate inside the human-owned control plane. They do not get to redefine it. Unknown actions fail closed to human_required.
...
Pressure-testing at depth revealed platform edges. The 4 `gh-aw` fixes I mentioned — including one shipped today ([v0.51.6](https://github.com/github/gh-aw/releases/tag/v0.51.6)) for auto-merge gating incorrectly blocking on non-required deployment statuses — came from running this pipeline hard enough to find the platform's limits.
...
**Years of hands-on AI experience:** 4
