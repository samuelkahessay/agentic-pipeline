...
public class KnowledgeEndpointTests : IClassFixture<WebApplicationFactory<Program>>
{
    ...
    public async Task SeedData_HasArticlesForAllCategories()
    {
        ...
        Assert.Contains(PRDtoProd.Models.TicketCategory.Bug, categories);
        Assert.Contains(PRDtoProd.Models.TicketCategory.HowTo, categories);
        Assert.Contains(PRDtoProd.Models.TicketCategory.FeatureRequest, categories);
        Assert.Contains(PRDtoProd.Models.TicketCategory.AccountIssue, categories);
        Assert.Contains(PRDtoProd.Models.TicketCategory.Other, categories);
    }
